...
namespace model_sfm_dhs_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_sfm_dhs");
    reader.add_event(106, 104, "end", "model_sfm_dhs");
    return reader;
}
#include <stan_meta_header.hpp>
class model_sfm_dhs
  : public stan::model::model_base_crtp<model_sfm_dhs> {
private:
        int G;
        int N;
        int Fac;
        ...
        std::vector<int> t_i;
public:
    model_sfm_dhs(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_sfm_dhs_namespace::model_sfm_dhs";
        ...
        try {
            ...
            validate_non_negative_index("omega", "G", G);
            validate_non_negative_index("omega", "Fac", Fac);
            num_params_r__ += (G * Fac);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        validate_non_negative_index("omega", "G", G);
        validate_non_negative_index("omega", "Fac", Fac);
        context__.validate_dims("parameter initialization", "omega", "matrix_d", context__.to_vec(G,Fac));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> omega(G, Fac);
        size_t omega_j_2_max__ = Fac;
        size_t omega_j_1_max__ = G;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                omega = in__.matrix_lb_constrain(0, G, Fac, lp__);
            else
                omega = in__.matrix_lb_constrain(0, G, Fac);
            current_statement_begin__ = 16;
            ...
            for (int f = 1; f <= Fac; ++f) {
                ...
                for (int g = 1; g <= G; ++g) {
                    ...
                    lp_accum__.add(normal_log<propto__>(get_base1(alpha_star, g, f, "alpha_star", 1), 0, (get_base1(omega, g, f, "omega", 1) * zeta)));
            ...
            lp_accum__.add(cauchy_log<propto__>(to_vector(omega), 0, 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_sfm_dhs_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> omega = in__.matrix_lb_constrain(0, G, Fac);
        size_t omega_j_2_max__ = Fac;
        size_t omega_j_1_max__ = G;
        for (size_t j_2__ = 0; j_2__ < omega_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < omega_j_1_max__; ++j_1__) {
...
typedef model_sfm_dhs_namespace::model_sfm_dhs stan_model;
#ifndef USING_R
